      ...
      <div className="relative z-1 min-h-screen bg-black/50 px-6 py-10">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          {notes.map((note) => (
            ...
            >
             <div className="bg-red-600 absolute z-0  h-full">
             <video src="/images/spidey.mp4" autoPlay loop muted playsInline className="h-full w-full object-cover" />
             </div>
             <div className="p-6 z-1">
              ...
              <div className="flex gap-4 ">
                <button onClick={() => deleteNote(note._id)} className="mt-4 rounded-xl bg-red-600 py-2 font-bold hover:bg-red-700 p-3">
                  Delete Note
                </button>

                <button onClick={() => setEdit(!edit)} className="mt-4 rounded-xl bg-red-600 py-2 font-bold hover:bg-red-700 p-3">
                  Edit Note
                </button>
                {edit && (
                  <div>
                    ...
                    <button onClick={() => {updateNote(note._id)}} className="w-full rounded-xl bg-red-600 py-3 font-bold hover:bg-red-700">
                      Update Note
                    </button>
                  </div>
                )}
